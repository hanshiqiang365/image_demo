...
root = Tk()
root.title('AI Face++ Morhper Tool （ 人脸融合） —— Developed by hanshiqiang365 （微信公众号）')
root.geometry('1200x500')
root.iconbitmap('facemorhper.ico')

decoration = PIL.Image.open('facemorhper_bg.jpg').resize((1200, 500))
...
Button(root, text = "人脸融合生成", width=15, height=2, font=10, command = show_morpher_pic).place(x=50,y=300)
Button(root, text = "退出", width=15, height=2, font=10, command = quit).place(x=50,y=360)

Label(root,text = "融合系数",width=15, height=1, font=10).place(x=50,y=10)
...
Label(root, text="融合效果", width=15, height=2, font=10).place(x=940,y=100)
